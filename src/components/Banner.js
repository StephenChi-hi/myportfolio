          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Chisom:`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "A Web Developer", "A Mobile App Developer", "A Web Flow Dev" ]'><span className="wrap">{text}</span></span></h1>
